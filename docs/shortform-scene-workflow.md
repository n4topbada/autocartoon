...
- Veo: 기존 기본 60, 6초 +20, 8초 +40, 1080p +40, 오디오 +10
- Seedance 720p: 초당 18크레딧
- Seedance 1080p: 초당 48크레딧

공급자 실제 청구는 달러·토큰·환율에 따라 달라진다. 결제 활성화 전 실제 사용 명세를 대조해 마진과 반올림 정책을 다시 확정한다.
