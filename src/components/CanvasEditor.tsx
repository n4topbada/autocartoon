                  ...
                  {selectedSpeechBubble && (
                    <>
                      ...
                      <section className={styles.optionSection}>
                        ...
                        <label className={styles.rangeLabel}><span>두께</span><b>{selectedSpeechBubble.strokeWidth}px</b></label><input type="range" min={0} max={16} step={0.1} value={selectedSpeechBubble.strokeWidth} onChange={(event) => updateBubble(selectedSpeechBubble.id, { strokeWidth: Number(event.target.value) })} />
